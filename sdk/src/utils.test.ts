...
function createAuditItem(overrides: Partial<LogAuditInput> = {}): LogAuditInput {
  return {
...
describe("utils", () => {
  ...
  describe("normalizeEventBridgetEventBody", () => {
    ...
    it("should return undefined for unsupported event types", () => {
      ...
      const result = normalizeEventBridgetEventBody(EventType.KinesisDataStreams, sqsRecord);
    ...
    it("should return undefined for DynamoDB event type", () => {
      ...
      const result = normalizeEventBridgetEventBody(EventType.DynamoDBStreams, sqsRecord);
  ...
  describe("getRecordId", () => {
    ...
    it("should return undefined for unknown event type", () => {
      ...
      const result = getRecordId("Unknown" as keyof typeof EventType, sqsRecord);
